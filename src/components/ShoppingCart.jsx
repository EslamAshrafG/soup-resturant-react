...
export default function ShoppingCart({
  ...
  return (
    <aside className="fixed top-0 right-0 border-2 h-full w-full md:w-[28rem] bg-white shadow-lg overflow-y-auto z-[10000] p-4 py-8">
      <button
      ...
      <div className="flex justify-between items-center w-10/12 mx-auto p-6 border-2 border-gray-300 rounded-md my-2">
      ...
      <button className="w-3/4 mt-auto absolute bottom-0 left-1/2 -translate-x-1/2 py-4 rounded-md  transition-all duration-300 text-center text-lg mb-4 bg-blue-600 hover:bg-blue-700 text-white ">
        Checkout
      </button>
    </aside>
  );
